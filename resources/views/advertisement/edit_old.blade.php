    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">ویرایش آگهی</h4>
                    </div>
                    <div class="content">
                        <form method="POST" action="{{ url('advertisement/' . $advertisement->id) }}">
                            @method('PATCH')
                            @csrf
                                ...
                                <div class="col-md-2">
                                    <select id="p_currency_id" class="form-control @error('p_currency_id') is-invalid @enderror"  name="p_currency_id">
                                        @foreach ($currency as $key => $value)
                                            <option value="{{ $key }}" @if($key == $advertisement->p_currency_id) selected = "selected" @endif>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-2">
                                    <select id="p_country_id" class="form-control @error('p_country_id') is-invalid @enderror"  name="p_country_id">
                                        @foreach ($country as $key => $value)
                                            <option value="{{ $key }}" @if($key == $advertisement->p_country_id) selected = "selected" @endif>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input id="amount_from" type="number" class="form-control @error('amount_from') is-invalid @enderror" name="amount_from" value="{{ $advertisement->amount_from }}" required autocomplete="amount_from">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <input id="amount_to" type="number" class="form-control @error('amount_to') is-invalid @enderror" name="amount_to" value="{{ $advertisement->amount_to }}" required autocomplete="amount_to">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <select id="r_currency_id" class="form-control @error('r_currency_id') is-invalid @enderror"  name="r_currency_id">
                                        @foreach ($currency as $key => $value)
                                            <option value="{{ $key }}" @if($key == $advertisement->r_currency_id) selected = "selected" @endif>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    <select id="r_country_id" class="form-control @error('r_country_id') is-invalid @enderror"  name="r_country_id">
                                        @foreach ($country as $key => $value)
                                            <option value="{{ $key }}"  @if($key == $advertisement->r_country_id) selected = "selected" @endif>
                                                {{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-round btn-warning btn-wd">
                                        ثبت تغییرات
                                    </button>
                                </div>
                            </div>
